...
public class Packet8PositionRotation implements IPacket {
    ...
    public Packet8PositionRotation() {}

    public Packet8PositionRotation(int entityId, double x, double y, double z, float yaw, float pitch) {
